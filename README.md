...
| Class         | What is it    | 
| ------------- |:-------------:|
| [AutoComplete](https://htmlpreview.github.io/?http://raw.githubusercontent.com/sjanarth/dsutils/master/docs/com/sjanarth/dsutils/samples/AutoComplete.html)     | <div dir="ltr">A complete type ahead (auto-complete) search system that provides fast queries (both prefix and topN) and granular updates </div>|
